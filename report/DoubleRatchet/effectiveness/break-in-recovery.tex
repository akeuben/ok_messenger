...
and the root key chain. These systems are in place to occasionally recreate the sending and receiving ratchets 
...
The Diffie-Hellman ratchet is built upon the Diffie-Hellman algorithm. Bob and Alice continuously generate new 
public/private key pairs. They send their public key to the other party, and upon reception of the key, they can derive 
...
repeats as long as Alice and Bob keep sending messages.
