...
\begin{enumerate}
    \item Authenticated Encryption with Associated Data algorithm.
        ...
        and we were familiar with the concepts. Coincidentally, this is also the recommended 
        ...
        and we were able to reuse it here as well. Further, SHA256 is the industry standard, and gaining a 
    ...
    \item Key Derivation Functions 
        ...
        For this, we followed the signal authors recommendation of HMAC-SHA256 and HKDF as our 
        ...
        and have been tested for many years. They are widely understood to be strong and secure algorithms.
...
As for the implementation of the actual Double Ratchet algorithm, we closely followed the documentation by signal.
The state for the algorithm is maintained in the class fields, preventing us from needing to pass the state around the application.
...
As with the other algorithms implemented in our project, there are unit tests 
...
Through the implementation (and more importantly, through debugging) of the Double Ratchet algorithm, our understanding 
...
sending multiple messages on one client in a row would crash the other client. In order to understand why the crash was occurring,
we had to form a stronger understanding of the Diffie-Hellman ratchet, since, as we learned, the Diffie-Hellman ratchet only changes 
