...
receiving ratchet. If Alice sends a message to Bob, she will perform a ratchet step on her sending 
ratchet to get a key $k$ to encrypt the message with. Bob, upon reception of the message, will perform 
a ratchet step on his receiving ratchet to get the same key $k$. The core idea here is that each party's 
sending ratchet is linked to the other party's receiving ratchet, and vice-versa.

In this section, we will discuss the implementation and effectiveness of 
