Our project was to reimplement the Signal protocol and explore and gain a deeper understanding of 
the cryptographic systems used in the protocol through reimplementation. The goal of the Signal protocol 
...
there are always attackers, big companies, or government agencies looking to gain access to our personal
...
The goal of our implementation was to create an end-to-end messaging application to allow two parties 
to communicate with each other using the Signal protocol. The final result includes a server that is only
...
given the time we had to complete this project, so we dropped that protocol in favour of a simpler server implementation.

The implementation of all algorithms in the protocol was evenly divided between the computer science members of the group (Avery and Joshua), while the analysis was assigned to our math member, Aritra.

The report assumes a baseline understanding of cryptographic primitives including SHA and AES, as well as an understanding of the Java programming language and Junit for unit testing.
...
allowing for an easy-to-implement persistent communication system.

Our implementation can be found at \url{http://www.github.com/akeuben/ok_messenger}
